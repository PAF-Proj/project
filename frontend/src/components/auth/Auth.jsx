...
const Auth = () => {
    ...
    return (
        //<div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-gray-50 to-PrimaryColor">
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-sky-100 to-indigo-600">
            ...
            <div className="relative w-[850px] h-[550px] bg-white m-5 rounded-3xl shadow-lg overflow-hidden">
                ...
                <div className="absolute w-full h-full">
                    ...
                    <div 
                        ...
                        bg-gradient-to-tr from-sky-50 to-indigo-100 border-r border-indigo-100 shadow-xl
                    ...
                    <div 
                        ...
                        bg-gradient-to-br from-sky-100 to-indigo-100 border-l border-indigo-100 shadow-xl

          ...
          <div className="bg-white shadow-md rounded-lg overflow-hidden">
            <div className="border-b border-gray-200">
              <nav className="flex">
                ...
                >
                  <i className='bx bx-star mr-2 text-lg'></i>
                  Highlights
                </button>
            ...
            <div className="p-6">
              {activeTab === 'posts' && (
                ...
                {activeTab === 'highlights' && (
                <Highlights 
                  posts={posts}  // Pass the user's posts array
                  formatPostDate={formatPostDate}  // Pass date formatting function
                  // Note: You could add more props here if needed for interaction
                />
              )}
